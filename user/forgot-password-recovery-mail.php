...
$query = mysqli_query($conn,"UPDATE user_login SET user_psw='".$genpass."' WHERE user_id=".$user['user_id'].'');
...
If ($query)
{
   //Set Params
    ...
    To change your password, please click  <a href='../user/homepage.php'>here</a>
