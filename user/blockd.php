...
$resultRoom=$conn->query("SELECT rr.rr_id,rr.rr_room_name,rr.rr_oku,rr.rr_status_value, rb.rb_block_name, rb.rb_block_name_alias FROM ref_room AS rr LEFT JOIN ref_block AS rb ON rr.rr_block=rb.rb_id WHERE rb.rb_id=4 AND rr.rr_oku=0 AND rr.rr_status_value=1 ORDER BY rr_room_name");
