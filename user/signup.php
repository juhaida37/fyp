...
<h3 class="margin">SIGN UP</h3>
  ...
  <div class="container">
    ...
    <label for="uname"><b>Matric Number :</b></label><br>
    <input type="text" placeholder="ABC123456" name="matric"  id="matric" style='width: 100%' required><br>

    <label for="uname"><b>Email :</b></label><br>
    <input type="text" placeholder="ABC@123.com" name="email"  id="email" style='width: 100%' required><br>
    ...
    <label>
      <span class="psw">By submitting this form you agree with the <a href="term.php" style="text-decoration: none" >Term & Conditions</a></span>
    </label>
