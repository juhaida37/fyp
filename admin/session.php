...
<form method="POST" action="action_session.php" class= "form-horizontal">

<div class="container">
  <div class="col-md-offset-2 col-md-8">

    <label for="session"><b>Add session :</b></label>
    <input class="form-control" type="text" placeholder="Enter session" name="session"  id="session" style='width: 100%' required><br>
...
if($result = mysqli_query($conn, $sql)){
  $counter =0;
        ...
        echo "<tr>";
            ...
            echo "<th class='text-center'>LIST SESSION :</th>";
      ...
      $status = $row['rs_activesess'];
      $button_status ="";
       if($status == 1)
      {
      $button_status ="<button id='btnStat' class='table-responsive btn btn-sm btn-danger text-center' onclick='changeStat(0,".$row['rs_id'].")'>Disable </button>";
      }
      else
      {
      $button_status ="<button id='btnStat' class='table-responsive btn btn-sm btn-success text-center' onclick='changeStat(1,".$row['rs_id'].")'>Enable </button>";
      }
          
      echo "<tr>";
          echo "<td class='text-center'>" . $counter . "</td>";
          echo "<td>" . $row['rs_session'] . "</td>";
...
$.ajax({
type: "POST",
url: "action_updatesession.php",
data: {idSess:id,statSess:stat},
dataType: "json",
