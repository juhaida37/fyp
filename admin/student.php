...
<h3 class="margin">STUDENT INFORMATION</h3>
...
$sql= "SELECT * FROM user_profile as up
  ...
  INNER JOIN ref_semester as rs ON up.up_session=rs.rs_id
  WHERE rs_id = 1";
    ...
    if(mysqli_num_rows($result) > 0){
      ...
      If ($counter == 1) {
            echo "<tr>";
                ...
                echo "<td><center>" . $row['rb_block_name_alias'] . "</td>";
            ...
            echo "<tr>";
                echo "<td class='text-center'>" . $counter . "</td>";
                echo "<td>" . $row['up_fullname'] . "</td>";
                echo "<td class='text-center'> <a a href='studentprofile.php?id=". $row['up_user_id'] ." ' target='new' >". $row['user_matric'] ."</a> </td>";
                echo "<td><center>" . $row['rb_block_name_alias'] . "</td>";
                echo "<td>" . $row['up_phonenumber'] . "</td>";
            echo "</tr>";
