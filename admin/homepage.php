...
<h3 class="margin">ADMIN SITE</h3>
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Enter Username" name="username"  id="username" style='width: 100%' required><br>

    <label for="psw"><b>Password :</b></label><br>
    <input type="password" placeholder="Enter Password" name="psw" id="psw" style='width: 100%' required><br><br>
